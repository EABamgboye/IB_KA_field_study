...
write.csv(kaduna_tpr_data, file.path(LuDir, "kadunatpr.csv" ))


kd_itn_df <-read_excel(file.path(Datadir, "ITN_distribution","household_member_ward_summaries_Itn_distribution", "ITN_distribution_total_ward_kaduna_2022.xlsx")) 
