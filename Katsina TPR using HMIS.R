...
##Read in HMIS data
hmis_2019 <- read_excel(file.path(Datadir, "nigeria_hmis", "HF Data 2019-2023", "HF Data 2019-2023", "NMEP Malaria 2019 Data.xlsx"), sheet = 1)
hmis_2020 <- read_excel(file.path(Datadir, "nigeria_hmis", "HF Data 2019-2023", "HF Data 2019-2023", "NMEP Malaria 2020 Data.xlsx"), sheet = 1)
hmis_2021 <- read_excel(file.path(Datadir, "nigeria_hmis", "HF Data 2019-2023", "HF Data 2019-2023", "NMEP Malaria 2021 HF Data.xlsx"), sheet = 1)

hmis_2022 <- read.csv(file.path(Datadir, "nigeria_hmis", "HF Data 2019-2023", "HF Data 2019-2023", "2022 HF Data", "2022 HF Data",
                                "Katsina 2022 2.csv"))

hmis_2023 <- read.csv(file.path(Datadir, "nigeria_hmis", "HF Data 2019-2023", "HF Data 2019-2023", "2023 HF Data", "2023 HF Data",
                                "Katsina 2023 2.csv"))
...
katsinatpr_201923 <- katsinatpr_201923 %>%
  mutate(ward = gsub("^kt ", "", ward), 
         ward = gsub("^kt ", "", ward), # Remove "ta " prefix
         ward = gsub(" Ward$", "", ward),  # Remove " Ward" suffix
  )

##Merge katsina shapefile to tpr data
kt_wardshp <- st_read(file.path(Datadir,"nigeria_shapefiles", "Nigeria Boundary Files_All", "Boundary_VaccWards_Export", "Boundary_VaccWards_Export.shp"))%>% 
...
write.csv(katsina_tpr_data, file.path(LuDir, "katsinatpr.csv" ))
