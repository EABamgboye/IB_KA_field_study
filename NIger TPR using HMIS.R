...
ni_wardshp <- st_read(file.path(Datadir,"nigeria_shapefiles", "Nigeria Boundary Files_All", "Boundary_VaccWards_Export", "Boundary_VaccWards_Export.shp"))%>% 
...
write.csv(niger_tpr_data, file.path(LuDir, "nigertpr.csv" ))
